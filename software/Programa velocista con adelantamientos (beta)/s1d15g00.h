...
#define  LCD_CS_PIN		        0x80000000   					// P1.31  (x000 0000 0000 0000 0000 0000 0000 0000)
#define  LCD_SCLK_PIN		    0x20000000						// P1.29  (00x0 0000 0000 0000 0000 0000 0000 0000)
#define  LCD_SDATA_PIN			0x00000008						// P0.3  (0000 0000 0000 0000 0000 0000 0000 x000)
#define  LCD_RESET_PIN			0x00000004						// P0.2  (0000 0000 0000 0000 0000 0000 0000 0x00)
#define  LCD_BL_PIN 		    0x40000000   					// P1.30  (0x00 0000 0000 0000 0000 0000 0000 0000)
...
#define  LCD_SDATA_DIR()		IO0DIR |= LCD_SDATA_PIN			// SDATA    = Output
#define  LCD_RESET_DIR()		IO0DIR |= LCD_RESET_PIN			// RESET#   = Output
...
#define  LCD_SDATA_HIGH() 		IOSET0  = LCD_SDATA_PIN			// SDATA  = '1' 
#define  LCD_SDATA_LOW() 		IOCLR0  = LCD_SDATA_PIN			// SDATA  = '0'
#define  LCD_RESET_HIGH() 		IOSET0  = LCD_RESET_PIN			// RESET# = '1' 
#define  LCD_RESET_LOW() 		IOCLR0  = LCD_RESET_PIN			// RESET# = '0'
...
extern void LCDWrite130x130bmp(const unsigned char *ptr);
