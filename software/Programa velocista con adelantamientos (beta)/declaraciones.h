...
#define Rastreo_cambio_lin	'1'
#define Rastreo_avanzar		'2'
...
#define MATCH_PRIO		2		// Prioridad del timer en modo match para el control periódico
...
#define MD_PWM			PWM2	// Canal de PWM de los motores derechos
